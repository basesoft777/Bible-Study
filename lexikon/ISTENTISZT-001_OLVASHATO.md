...
```mermaid
graph LR
    A["Séth kora<br/>(1Móz 4:26)"] --> B["Próféciai<br/>ígéret<br/>(Jóel 2:32)"]
    B --> C["Pünkösd<br/>(ApCsel 2:21)"]
    B --> D["Pál<br/>(Róm 10:13)"]
    A -.->|"fordítva!"| E["Isten kihirdeti<br/>saját nevét<br/>(2Móz 33:19)"]
    F["Ábrahám<br/>(1Móz 12:8, 13:4)"] --> G["Izsák<br/>(1Móz 26:25)"]

    style E fill:#f8d7da,stroke:#721c24,stroke-width:2px,color:#000000
```
