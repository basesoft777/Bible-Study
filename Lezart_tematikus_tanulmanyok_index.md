...
*Utolsó frissítés: 2026.09.11, a v56 motívumlog alapján — új tétel: #9 (Bűn következményeinek gyűrűzése). Korábban: 2026.09.10, a v55 motívumlog alapján — #8 (Melkizedek) frissítve a 2026.09.08-09-i bővítéssel (2Móz 19:6, Zak 6:13, 1Pét 2:9); #4 (Segítségül hívni) frissítve a 2026.09.08-i bővítéssel (Zak 13:9, hat ÚSZ igehely, D-minta kizárása); #3 (Hádész/seól) önálló fájlba kiszervezve (`Hadesz_Seol_tematikus.md`), előfordulás-szám 4→6 korrigálva.*

---

| # | Motívum | Fájlnév | Érintett igehelyek | Megjegyzés |
|---|---|---|---|---|
| 1 | **Tehóm — Abüsszosz: a mélység motívuma** | `Tehom_tematikus.md` | 1Móz 1:2 ↔ 7:11 ↔ 8:2 ↔ 49:25 ↔ 2Móz 15:5,8 (5 fő genezisi/Tóra-szintű előfordulás; teljes kánoni mező: 35 ÓSZ + 9 ÚSZ, valódi TAHOT/TAGNT-scannel 2026.09.10-én megerősítve, 3 új ÓSZ-igehellyel: Zsolt 36:7, 77:17, Jón 2:6) | Tóra-szintű ívvé kiterjesztve; a tematikus tanulmány önmagában tartalmazza a teljes elemzést. 2026.09.10-én összevonva a korábbi #2 (`Tehom_Abusszosz_Hadesz_Tartarosz_tematikus.md`) tartalmával — az a fájl törölve, mert a napló sosem adott önálló ID-t az ábüσσος-anyagnak. A Tartarosz egy rövid kereszthivatkozó bekezdés marad; a hádész/seól (`[ID: ALVIL-001]`) továbbra is önálló fájlban él, l. #3. |
| 3 | **Hádész (seól) — a halottak birodalma** | `Hadesz_Seol_tematikus.md` | Zsolt 16:10 ⇒ ApCsel 2:27,31 → Luk 16:23 → Jel 6:8 → Luk 10:15/Mát 11:23 → Jel 20:13-14 (6 előfordulás) | 2026.09.10-ig a #2 kibővített tanulmányon (`Tehom_Abusszosz_Hadesz_Tartarosz_tematikus.md`) belül élt, innentől önálló fájlban — a napló mindig is külön ID-ként (`[ID: ALVIL-001]`) tartotta nyilván. Lexikailag élesen elkülönül a tehóm/abüsszosz-családtól. |
| 4 | **Segítségül hívni az Úr nevét — Énós kora** | `Segitsegul_hivni_az_Urat_tematikus.md` | 1Móz 4:26 → 12:8 → 13:4 → 21:33 → 26:25 (5 előfordulás) | Kánoni kitekintés (nem külön számlálva): 1Kir 18:24-26, 2Kir 5:11, Zsolt 116, Sof 3:9, Zak 13:9, Jóel 3:5/2:32 ⇒ ApCsel 2:21 ⇒ Róm 10:13 ⇒ Róm 10:14. 2026.09.08-án bővítve hat ÚSZ igehellyel (1Kor 1:2, 2Tim 2:22, 1Pét 1:17, ApCsel 9:14, 9:21, 22:16) és egy kizárt D-mintával (Zsid 11:16). |
...
- ~~`Rafaim_Gibborim_Nefilim_tematikus.md`~~ → **átnevezve**: `Rafaim_tematikus.md` (2026.08.21) — korábban tévesen egybefoglalt egy másik, azóta önálló fájlt kapott motívumot (Isten fiai/Nefilim/Gibborim, ld. index #7)
