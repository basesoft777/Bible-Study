...
| v9 | 2026.09.22 | **E1–E2: a 6. Értelmezés lexikai kiegészítése és az új felismerés alszakasz** (`ISTENTISZT_V3_ERTELMEZES.md`). Kézi szövegbeszúrás a `lexikon/ISTENTISZT-001_TUDOMANYOS.md` 6. szakaszában, két horgony-sorhoz kötve, mindkettő 1/1 illeszkedéssel. E1 — a Remez-szintű Drash-bekezdés elé (+34 sor): a Septuaginta fordítói következetessége (18/22 ἐπικαλέομαι, a 3 eltérés — 2Móz 33:19/34:5 καλέω, Ézs 12:4 βοάω, Zsolt 116:17 LXX-minusz — magyarázott), a Thayer 5. jelentés-ága (a motívum ÚSZ-i helyei mind ide tartoznak), és a Róm 10:12 mint a 10:13 egyetemes ígéretének bevezetője. E2 — a `## 7. Módszertan…` cím elé, a Rashi-vita zárójele után (+51 sor): „Új felismerés — a D-minta görög folytatása" alszakasz — a Thayer 2. jelentés-ága és az UBS Louw–Nida 11.28 a D-mintát (נִקְרָא...עַל) önálló ÚSZ-i folytatásként azonosítja (ApCsel 15:17, Jak 2:7, és — az UBS szerint, eltérő olvasatként — ApCsel 9:14); explicit korlátozással, hogy ez nem állítja e helyeket a motívum előfordulásává, és a study-ba szándékosan nem került be. Más fájl nem változott. `ellenoriz.py` kód 0 (SÉRTÉS: 0); `general.py --cel lexikon --ellenoriz` mind a 8 oldalra „nincs írás" — a kézi szakasz nem érinti a generált blokkokat. Sorszám: 1279 → 1364. |
