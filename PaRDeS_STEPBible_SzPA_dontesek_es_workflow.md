...
> **⚠️ MIGRÁLVA — F1.6, 2026.09.13. Ez a szakasz archívum, nem munkalista.**
>
> A `[ ]` tételek új helyükre kerültek, és **ott karbantartandók**:
> - **vers-szintű jelöltek** → `adat/jeloltek.tsv` (`dontes=nyitva`)
> - **infrastruktúra / policy / kutatási tételek** → `NYITOTT_FELADATOK.md`
>
> Az `[x]` és `[⏸️]` tételek itt maradnak, lezárt döntésként, hivatkozási alapnak.
> A szakaszba a `DONTESEK_INDEX.tsv` mutat; **teljes beolvasása nem kötelező.**
>
> A migráció tételes újraellenőrzéssel járt, amely **három elavult állítást** talált
> ebben a szakaszban — l. alább a ⏹ jelöléseket.
...
- [x] **A négy már lezárt tematikus tanulmány visszamenőleges STEPBible-ellenőrzése — feltáró fázis lezárva (v34).** A teljes körű TAHOT/TAGNT-grep lefutott mind a négy tanulmány kulcs Strong-számára/számaira, `tematikus_lezart/Konnyu_ellenorzes_4_lezart_tanulmany.md` — 199 "ÚJ ELŐFORDULÁS TALÁLVA" + 5 "ROKON GYÖKŰ JELÖLT" + 4 "NEM ELLENŐRIZHETŐ, konkordancia-rés" jelölt, emberi döntésre várva. **A Károli-Strong join-építés még NEM történt meg** — ez, valamint a talált jelöltek tartalmi értékelése (valódi lexikai egyezés vs. felszíni egybeesés) külön, következő lépés marad:
  ...
  - [ ] Segítségül hívni az Úr nevét tematikus tanulmány — 94 új jelölt tartalmi értékelése (⚠️ a keresési módszer zajos, első lépésként érdemes eldönteni, szándékosan szűk-e a tanulmány tárgya) + join-építés — **szándékosan kihagyva a v47-es körből**, továbbra is nyitott
    - ⏹ **ELAVULT (F1.6 ellenőrzés, 2026.09.13).** A „94 jelölt" (65 ÓSZ + 29 ÚSZ) a `Konnyu_ellenorzes_4_lezart_tanulmany.md` saját jelzése szerint is **zajos keresésből** származott. Azóta jobb módszertanú kör futott: 2026.09.08-án a G1941 mind a 31 ÚSZ-előfordulásának egyenkénti áttekintése, valamint H7121+H8034 kombinált teljes ÓSZ-scan (196 nyers találat, a gyermeknévadási formula mint zaj kiszűrve). Ennek eredményeként a study **hat új ÚSZ-igehellyel bővült**, egy negyedik (D) mintát dokumentált és explicit kizárt, és megkapta a Q1-Q5 kaput. A „94 jelölt" tétel tehát **nem nyitott feladat, hanem felülírt mérőszám** — nem migrálva.
  ...
  - [x] **Hádész (+ Tehóm/Abüsszosz/Tartarosz-komplexum) tematikus tanulmány — lezárva a G0086 ág tekintetében (v47).** A 4 G0086-os jelölt tartalmi értékelése megtörtént: 3 BEKERÜLT (Jel 6:8 a fő ívbe; Luk 10:15 + Mat 11:23 önálló "hübrisz/megaláztatás" alágként), 1 KIZÁRVA (Mat 16:18, ekkleziológiai regiszter) — mind a 4 sor felkerült a join-táblába (a kizárt is, jelölve). **A hádész-komplexum 46 seól-jelöltje (H7585 teljes lexikai mező) továbbra is nyitott**, szándékosan kihagyva e körből.
    - ⏹ **ELAVULT (F1.6 ellenőrzés, 2026.09.13).** A teljes H7585-scan azóta **lefutott**: a `Hadesz_Seol_tematikus.md` v2 (2026.09.10) 66 nyers szóelőfordulást / **64 egyedi verset** vizsgált, ebből **64 beépítve**, Hós 13:14 kiemelt leletként (Pál 1Kor 15:55-ben idézi). Dokumentálva: `tematikus_lezart/naplok/Hadesz_Seol_kereszthivatkozas_naplo.md`. **Nem nyitott** — nem migrálva.
...
- [ ] Php 1:27 végleges döntés — bekerüljön-e ötödik (korporatív jellegű) előfordulásként a pneuma/pszükhé tanulmányba
  - ⏹ **MIGRÁLVA (F1.6, 2026.09.13)** → `adat/jeloltek.tsv`, `ANTROP-001` / **`Fil 1:27`**, `dontes=nyitva`. Ellenőrizve: a study szövege ma sem említi, tehát valóban nyitott. *A kanonikus igehely-alak `Fil 1:27`, nem `Php 1:27` — l. `konkordancia/Konyv_normalizalo_tabla.tsv`.*
