# PaRDeS-projekt: STEPBible/SzPA integráció és GitHub-architektúra — döntési összefoglaló (v34)
...
- [x] **A négy már lezárt tematikus tanulmány visszamenőleges STEPBible-ellenőrzése — feltáró fázis lezárva (v34).** A teljes körű TAHOT/TAGNT-grep lefutott mind a négy tanulmány kulcs Strong-számára/számaira, `tematikus_lezart/Konnyu_ellenorzes_4_lezart_tanulmany.md` — 199 "ÚJ ELŐFORDULÁS TALÁLVA" + 5 "ROKON GYÖKŰ JELÖLT" + 4 "NEM ELLENŐRIZHETŐ, konkordancia-rés" jelölt, emberi döntésre várva. **A Károli-Strong join-építés még NEM történt meg** — ez, valamint a talált jelöltek tartalmi értékelése (valódi lexikai egyezés vs. felszíni egybeesés) külön, következő lépés marad:
  - [ ] Tehóm tematikus tanulmány — 24 új jelölt tartalmi értékelése + join-építés
  - [ ] Segítségül hívni az Úr nevét tematikus tanulmány — 94 új jelölt tartalmi értékelése (⚠️ a keresési módszer zajos, első lépésként érdemes eldönteni, szándékosan szűk-e a tanulmány tárgya) + join-építés
  - [ ] Rafeusok/óriás-népek tematikus tanulmány — 6 új jelölt (Refáim-völgy) + 3 rokon gyökű jelölt (különösen H8655 teráfim) tartalmi értékelése + join-építés
  - [ ] Hádész (+ Tehóm/Abüsszosz/Tartarosz-komplexum) tematikus tanulmány — 75 új jelölt tartalmi értékelése + join-építés
