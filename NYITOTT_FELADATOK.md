...
5. Cremer utóélete a SZOTAR-ban (2026.09.25; a `CREMER_OCR_BRIEF.md` v3 lezárva, D20–D22). Javaslat, még nem jóváhagyva: a SZOTAR S7/D8/D12 módosítása — a Cremer szövege nem kerül importálásra, a szótári háttérben csak oldalhivatkozás áll archive.org-linkkel (cremuoft, a brief Lezárás szakaszának leképezésével), ahol az Abbott-Smith megadja; a `Cremer_szocikkek.tsv` és a `Cremer_heber_mutato.tsv` kikerül a tervből. Ha egy szócikk szövege mégis kellene: célzott kinyerés (szómutató → oldal ±2 → levél → szócikkhatár → gyanús görög és minden héber hely lapképpel → jóváhagyás); becslés: rövid szócikk 5–10 perc, nagy szócikk (5–15 oldal) 30–60 perc átnézés, a valós szóra cserélt görög (ὅτε/ὅτι) miatt a render által használt szócikkeknél teljes olvasással; a héber mutató (kb. 9 lap, level 949–957) egyszeri átírást igényel.
6. Szótári szerepmátrix felülvizsgálata (`adat/szotar_szerepek.tsv`; 2026.09.25, chat-megbeszélés). Nyitott döntések:
   - **NIDNTTE / NIDOTTE** mint bibliai-teológiai szóvizsgálat: tartalmilag a legjobb jelölt (modern, a NIDNTTE Barr kritikája után átdolgozott módszertannal), de jogvédett (Zondervan): a repóba csak hivatkozás (szócikkszám, kötet:oldal) kerülhet; tartalom csak a kézi szakaszokba, rövid idézetként (szócikkenként legfeljebb néhány mondat, forrásmegjelöléssel, magyar fordítással), az idézet a felhasználó példányából jön, soha nem Claude emlékezetéből. Javasolt állapotérték: `hivatkozás + kézi idézet`. **Előfeltétel: hozzáférés a kötetekhez — tisztázandó.**
   - A Cremer/Girdlestone sor átnevezése „Történeti teológiai szócikk (hivatkozás)”-ra; a Girdlestone külön vizsgálandó.
   - **Licencoszlop** a szerepmátrixba: forrásonként licenc és az, hogy mi kerülhet a repóba (teljes szöveg / kivonat / csak hivatkozás).
   - Elvetett alternatív mátrix-javaslat (Strong mint alaplexikon, LSJ mint teljes és etimológiai lexikon, „STEPBible lexikai adatok” mint szemantikai mező, morfológia és szöveg mint szerep, Nave's mint fogalmi háttér): a Strong glosszái szűkek (a TBESG/TBESH kiváltja), az LSJ nem ÚSZ-mélységű és alig etimologizál (a használt digitális LSJ licence ellenőrizendő, tudtommal CC BY-SA), a STEPBible-lexikonoknak nincs tartományrendszere (a UBS DNTG/DBH van), a morfológia és a szöveg a konkordancia rétege, nem szótári szerep; a LXX-híd, a SECE-megfelelők, a tömör jelentés és a kiejtés sorai nem hagyhatók el.
7. Forrásjelöltek a GitHub-szemléből (2026.09.25; jcuenod/awesome-bible-data és 11 további link). Vizsgálandó, sorrendben:
...
* A Cremer teljes szövegének javítása külső modellekkel (O-pipeline) lezárva, D22. Eredmény: a cremuoft-tétel azonosítása (görög betűs OCR), élőfej-alapú leképezés, módszertani tanulságok (D20–D21), ellenőrző csomag (`96c4c5d`). Folytatás: 5. tétel (Cremer utóélete a SZOTAR-ban).
