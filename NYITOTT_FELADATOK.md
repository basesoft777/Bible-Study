...
5. Olvasói szint — finomhangolható, többtengelyes konfiguráció (ÚJ, 2026.09.08, koncepcionális fázis, l. `motivumlog/Olvasoi_szint_tervezesi_naplo.md`) — cél: a studyk/lexikon-cikkek munkapéldányából reprodukálható, nem persona-improvizált módon előállítani egy olvasóbarátabb változatot, 4 független, 1-5 fokozatú paraméterrel (terminológia, apparátus, mondatszerkezet, indoklás-sűrűség) hangolva. Előfeltétel: egységes napló-jelölés bevezetése (jelenleg 3 inkonzisztens minta van használatban) + mondaton belüli keveredés tiltása írás közben. Basesoft döntése: pilot szükséges egy kiválasztott dokumentumon, mielőtt bármi szabályként rögzülne. Nincs kiválasztott pilot-dokumentum.
