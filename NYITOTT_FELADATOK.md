...
5. ISTENTISZT-001 lexikon-oldal frissítése a study jelenlegi (24-igehelyes) állapotára (ÚJ, 2026.09.09) — a `motivumlog/lexikon_pilot/ISTENTISZT-001_TUDOMANYOS.md` "1. Előfordulások" táblázata még a régi, 17-tételes állapotban van, miközben a `tematikus_lezart/Segitsegul_hivni_az_Urat_tematikus.md` már 24 igehelyet dokumentál. Hiányzik: Zak 13:9 önálló táblázat-sorként; 1Kor 1:2, 2Tim 2:22, 1Pét 1:17, ApCsel 9:14, 9:21, 22:16 mind a hat helyen (csak a Thayer-szócikk saját idézetében bukkannak fel, nem a lexikon-oldal saját elemzéseként); a teljes D-minta (נִקְרָא...עַל birtoklás-szerkezet) sem felvéve, sem kizárva. Ebből következően a KAPCSOLATOK-réteg (7. pont, diagram + alátámasztás-táblázat + `Motivum_kapcsolatok_PILOT.tsv`) is hiányos. Nem kozmetikai, érdemi tartalmi munka: 7 új táblázat-sor + D-minta dokumentálása + KAPCSOLATOK-diagram bővítése.
...
* 6 további tematikus study v12-compliance (nagy, több körös munka; a korábbi 7-ből a Melkizedek 2026.09.09-én lezárult) — a Quality Gate (Q1-Q5) most már explicit követelményként vonatkozik rájuk, ha bármelyiket lezárjátok/átdolgozzátok
* NAPLO-jelölés retrospektív egységesítése a bővített és egyéb tematikus studykban (ÚJ, 2026.09.09) — eddig csak a Melkizedek- és a segítségül hívni-studyn futott le szisztematikusan a mondaton belüli tartalom/proveniencia-keveredés tesztje; a többi bővített/tematikus study még nincs átnézve
* 6 küszöbön-túli, még meg sem írt motívum (ÚJ, 2026.09.09, l. `PaRDeS_motivumok.md` ⭐ szakasz) — HAMART-001 (bűn következményeinek gyűrűzése), ANTROP-002 (uralom-megbízás), ANTROP-003 (Isten képmása), TEREMT-002 (תהו/בהו mint ítélet-nyelvezet), ISTENTISZT-002 (oltárépítés), SZOVETS-001 (brít első előfordulása) — mindegyik felhasználói jóváhagyásra vár
* Tehóm/Seól (H8415/H7585) — teljes lexikai mező audit szükséges (ÚJ, 2026.09.09, pontosítva): a korábbi 27/46-os (illetve tévesen 63-ként rögzített) jelölt-számok a hiányosnak bizonyult régi `TAHOT_kivonat.tsv`-ből származnak; frissen újraszámolva a javított adaton 34, ill. 64 egyedi igehely jött ki. A Tehóm-motívum valószínűleg gyakorlatilag lezárt (24/24 jelölt beépítve a v47-es körben, 2026.08.25) — egy gyors megerősítő újra-scan elegendő lenne. A Seól-motívum jelölt-listája továbbra is valóban nyitott, de a régi 46-os lista elavult; egy teljes, friss H7585-scan szükséges, mielőtt a tartalmi értékelés elkezdődne.
...
* ISTENTISZT-001 lexikon TUDOMÁNYOS oldal — tartalom/proveniencia-tisztítás, commit `99f63dc`. Tartalmilag NEM frissítve a study 24-igehelyes állapotára — l. nyitott lista, új 5. tétel.
...
* Olvasói szint pilot lezárva és naplózva — l. 5. nagy tétel frissítése fent
