...
with open("naplok/KAROLI_KK1b_kulcstabla_tervezet.tsv", "w", encoding="utf-8") as out:
    out.write("# GENERALT-TERVEZET: naplok/KAROLI_KK1b_kulcstabla_general.py - jovahagyasra var, meg NEM elesitett\n")
